...
@oclif/example-multi-ts/1.7.4 linux-x64 node-v9.9.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.7.4/src/commands/hello.ts)_
...
_See code: [@oclif/plugin-help](https://github.com/oclif/plugin-help/blob/v1.2.0/src/commands/help.ts)_
<!-- commandsstop -->
