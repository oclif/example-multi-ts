...
@oclif/example-multi-ts/1.7.38 linux-x64 node-v10.0.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.7.38/src/commands/hello.ts)_
