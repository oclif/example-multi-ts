...
@oclif/example-multi-ts/1.4.11 linux-x64 node-v9.8.0
...
_See code: [lib/commands/hello.js](https://github.com/oclif/example-multi-ts/blob/v1.4.11/lib/commands/hello.js)_
