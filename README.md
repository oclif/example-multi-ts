...
@oclif/example-multi-ts/1.7.45 linux-x64 node-v10.1.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.7.45/src/commands/hello.ts)_
