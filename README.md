...
@oclif/example-multi-ts/1.7.51 linux-x64 node-v10.2.1
...
_See code: [src/commands/goodbye.ts](https://github.com/oclif/example-multi-ts/blob/v1.7.51/src/commands/goodbye.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.7.51/src/commands/hello.ts)_
