...
@oclif/example-multi-ts/1.1.0 (linux-x64) node-v9.5.0
...
_See code: [@oclif/example-multi-ts](https://github.com/oclif/example-multi-ts/blob/v1.1.0/src/commands/hello.ts)_
