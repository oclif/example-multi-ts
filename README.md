...
@oclif/example-multi-ts/1.3.6 (linux-x64) node-v9.5.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.3.6/src/commands/hello.ts)_
