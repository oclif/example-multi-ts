...
@oclif/example-multi-ts/1.5.8 linux-x64 node-v9.9.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.5.8/src/commands/hello.ts)_
