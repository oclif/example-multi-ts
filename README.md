...
@oclif/example-multi-ts/1.3.14 (linux-x64) node-v9.8.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.4.0/src/commands/hello.ts)_
