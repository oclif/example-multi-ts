...
@oclif/example-multi-ts/1.5.3 linux-x64 node-v9.9.0
...
_See code: [lib/commands/hello.js](https://github.com/oclif/example-multi-ts/blob/v1.5.3/lib/commands/hello.js)_
