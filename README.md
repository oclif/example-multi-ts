...
@oclif/example-multi-ts/1.7.9 linux-x64 node-v9.10.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.7.9/src/commands/hello.ts)_
