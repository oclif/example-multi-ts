...
@oclif/example-multi-ts/1.10.6 linux-x64 node-v10.10.0
...
_See code: [src/commands/goodbye.ts](https://github.com/oclif/example-multi-ts/blob/v1.10.6/src/commands/goodbye.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.10.6/src/commands/hello.ts)_
