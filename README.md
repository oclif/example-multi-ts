...
@oclif/example-multi-ts/1.5.7 linux-x64 node-v9.9.0
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.5.7/src/commands/hello.ts)_
...
_See code: [@oclif/plugin-help](https://github.com/oclif/plugin-help/blob/v1.1.8/src/commands/help.ts)_
<!-- commandsstop -->
