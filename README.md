...
@oclif/example-multi-ts/1.8.6 linux-x64 node-v10.5.0
...
_See code: [src/commands/goodbye.ts](https://github.com/oclif/example-multi-ts/blob/v1.8.6/src/commands/goodbye.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/oclif/example-multi-ts/blob/v1.8.6/src/commands/hello.ts)_
